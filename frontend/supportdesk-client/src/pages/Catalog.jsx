      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
          ...
          <select
            ...
            className="bg-white rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-secondary shadow-sm w-full sm:w-auto"
          >
      ...
      {totalPages > 1 && (
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 sm:mt-8">
          <button
            ...
            className="w-full sm:w-auto px-4 py-2 rounded-lg bg-white shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Previous
          </button>
